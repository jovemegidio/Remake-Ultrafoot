...
import { Activity, BarChart3, BrainCircuit, CalendarRange, HeartPulse, Save, ShieldCheck } from "lucide-react"
...
export default function PerformancePage() {
  ...
  return <div className="flex h-screen flex-col overflow-hidden bg-[#050508] text-white">
    ...
    <main className="flex min-h-0 flex-1 flex-col px-6 pb-8 pt-5">
      <div className="flex items-end justify-between border-b border-white/[0.07]"><div><p className="text-xs font-semibold uppercase tracking-[.22em] text-[var(--brand)]">Performance Center 279</p><h1 className="mt-1 text-2xl font-black">Decisões de futebol integradas</h1></div><span className="mb-3 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/50">Projeções: {projectionEngine === "rust" ? "motor Rust nativo" : "fallback TypeScript"}</span></div>
