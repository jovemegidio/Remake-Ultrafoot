        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="space-y-4 lg:col-span-1">
            ...
            <div className="max-h-[calc(100vh-310px)] space-y-2 overflow-y-auto">
              {filteredMessages.length === 0 ? <div className="uf-card p-8 text-center"><Mail className="mx-auto mb-3 h-10 w-10 text-white/20" /><p className="text-sm text-white/50">Nenhuma mensagem real registrada nesta carreira.</p></div> : filteredMessages.map(notification => {
