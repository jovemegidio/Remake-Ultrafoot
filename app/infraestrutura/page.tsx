...
import { BlocoRecolhivel as Bloco } from "@/components/bloco-recolhivel"
  ...
  return (
    ...
    <div className="relative flex h-screen flex-col overflow-hidden md:pl-0 pl-0 pb-20 md:pb-0">
      ...
      <main className="flex min-h-0 flex-1 flex-col">
        ...
        {/* Recolhido por padrão: são QUATRO campos de preço editáveis mais a
            modal de obra. Aberto direto, é o bloco que mais pesa na tela — e na
            maioria das visitas o técnico só quer conferir a renda, que já está
            no resumo aqui do lado. */}
        <Bloco
