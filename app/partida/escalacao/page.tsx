...
// FORMATIONS agora vive em lib/formations.ts (compartilhado com o Gerenciamento).
...
// buildElencoPlayers agora vive em lib/use-user-roster.ts (compartilhado com o Gerenciamento).
...
export default function PartidaEscalacaoPage() {
  ...
  // (RB Bragantino) e um useState que congelava o elenco montado no primeiro render —
  ...
  // Esta tela tinha a MESMA logica por indice do gerenciamento: um zagueiro caia no
  // slot de lateral, um meia no de zagueiro. Agora as duas usam o mesmo helper.
   ...
   * Melhor mostrar "carregando" por um instante do que escalar o elenco de outro clube.
