...
export function FM26CommandCenter() {
  ...
  return <>
    ...
    {(buscaAberta || favoritosAbertos || guiaAberto) && <div className="fixed inset-0 z-[100] grid place-items-start uf-veu px-4 pt-[8vh]" onClick={() => { setBuscaAberta(false); setFavoritosAbertos(false); setGuiaAberto(null) }}>
