...
export const competitionThemes: Record<CompetitionId, CompetitionTheme> = {
  ...
  paulistao: {
    ...
    colors: {
      ...
      secondary: "#1a1a1a",
      accent: "#ffffff",
      background: "linear-gradient(135deg, #4a0d15 0%, #0a0a0a 100%)",
      gradient: "linear-gradient(90deg, #c41e3a 0%, #8b0000 50%, #ff4d6a 100%)",
      text: "#ffffff",
  ...
  mineiro: {
    ...
    colors: {
      ...
      secondary: "#1a1a1a",
      accent: "#bb6bd9",
      background: "linear-gradient(135deg, #3d1a50 0%, #0a0a0a 100%)",
      gradient: "linear-gradient(90deg, #8e44ad 0%, #5e2670 50%, #bb6bd9 100%)",
      text: "#ffffff",
      textSecondary: "#bb6bd9",
    },
    headerStyle: "gradient",
  },
  gaucho: {
  ...
  supercopa: {
    ...
    colors: {
      ...
      secondary: "#1a1a1a",
      accent: "#ffed4a",
      background: "linear-gradient(135deg, #4a3f00 0%, #0a0a0a 100%)",
      gradient: "linear-gradient(90deg, #ffd700 0%, #b8860b 50%, #ffed4a 100%)",
      text: "#1a1a1a",
  ...
  mundial_clubes: {
    ...
    colors: {
      ...
      secondary: "#1a1a1a",
      accent: "#87ceeb",
      background: "linear-gradient(135deg, #0d3a66 0%, #0a0a0a 100%)",
      gradient: "linear-gradient(90deg, #1e90ff 0%, #0066cc 50%, #87ceeb 100%)",
      text: "#ffffff",
