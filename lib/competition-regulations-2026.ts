...
const CORE_COMPETITION_REGULATIONS_2026: Record<string, CompetitionRegulation2026> = {
  ...
  brasileirao_d: { id: "brasileirao_d", name: "Brasileirão Série D", participants: 96, format: "16 grupos de 6, dez rodadas; G4 de cada grupo avança ao mata-mata; seis clubes sobem à Série C (os quatro eliminados nas quartas disputam playoff)", promotion: 6, season: 2026, startsOn: "2026-04-05", endsOn: "2026-09-13", calendarPolicy: "after-state" },
