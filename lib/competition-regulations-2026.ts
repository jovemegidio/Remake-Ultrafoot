...
export interface CompetitionRegulation2026 {
  ...
  /**
   * NOME DO TÍTULO DA PRIMEIRA FASE, quando a federação premia quem a lidera.
   *
   * Existe por causa da Taça Guanabara. Ela não é um torneio à parte: é o nome
   * que a FERJ dá à fase de grupos do Carioca, e o líder da classificação geral
   * ao fim dela leva um título de verdade. Como o regulamento aqui já descreve
   * exatamente essa fase, o que faltava não era competição nova — era nomear a
   * fase e emitir o título dela. Inventar uma competição paralela duplicaria a
   * fase de grupos e faria o clube disputar a mesma coisa duas vezes.
   *
   * Vale para qualquer estadual com o mesmo desenho; por ora só o Carioca tem
   * fonte para isso.
   */
...
const CORE_COMPETITION_REGULATIONS_2026: Record<string, CompetitionRegulation2026> = {
  ...
  brasileirao_c: { id: "brasileirao_c", name: "Brasileirão Série C", participants: 20, format: "Grupo único; G8 em dois quadrangulares; dois primeiros de cada grupo sobem; os dois últimos caem para a Série D", promotion: 4, relegation: 2, season: 2026, startsOn: "2026-04-05", endsOn: "2026-10-25", calendarPolicy: "after-state" },
  // O REGULAMENTO DESCREVE O QUE O JOGO DISPUTA, nao a competicao real.
  // A Serie D de verdade tem 96 clubes em 16 grupos; aqui ela e uma chave unica
  // de 20, como as outras divisoes (ver o comentario no catalogo). Enquanto isto
  // dizia 96, a tela do regulamento anunciava um torneio que nao existia e o
  // qa:competitions acusava divergencia entre catalogo e regulamento.
  brasileirao_d: { id: "brasileirao_d", name: "Brasileirão Série D", participants: 20, format: "Chave única de 20 clubes em turno e returno; os quatro primeiros sobem à Série C", promotion: 4, season: 2026, startsOn: "2026-04-05", endsOn: "2026-09-13", calendarPolicy: "after-state" },
  ...
  carioca_a1: { id: "carioca_a1", name: "Campeonato Carioca A1", participants: 12, format: "Dois grupos de seis enfrentam a outra chave em seis rodadas, valendo a Taça Guanabara para o líder da classificação geral; G8 nas quartas; quartas e semifinais sem vantagem e com pênaltis", relegation: 1, season: 2026, firstPhaseRounds: 6, groups: 2, knockout: ["quartas", "semifinal", "final"], knockoutLegs: { quartas: 1, semifinal: 1, final: 2 }, finalLegs: 2, startsOn: "2026-01-11", endsOn: "2026-03-08", calendarPolicy: "season-cycle", clubs: ["Bangu", "Boavista", "Botafogo", "Flamengo", "Fluminense", "Madureira", "Maricá", "Nova Iguaçu", "Portuguesa-RJ", "Sampaio Corrêa-RJ", "Vasco da Gama", "Volta Redonda"], source: "FERJ REC 2026", firstPhaseTitle: "Taça Guanabara" },
  ...
  // O Mundial no formato de 32 (a cada 4 anos: 2025, 2029...) e a Intercontinental
  // anual nao tinham regulamento — o Mundial era tratado como supercopa de 2
  // clubes e a Intercontinental nao existia.
  mundial_clubes: { id: "mundial_clubes", name: "Mundial de Clubes FIFA", participants: 32, format: "32 clubes em 8 grupos de 4; os dois primeiros de cada grupo avançam às oitavas; mata-mata em jogo único até a final. Disputado a cada quatro anos, com vaga por título continental no ciclo", season: 2026, firstPhaseRounds: 3, groups: 8, knockout: ["oitavas", "quartas", "semifinal", "final"], knockoutLegs: { oitavas: 1, quartas: 1, semifinal: 1, final: 1 }, finalLegs: 1, source: "FIFA Club World Cup", validationLevel: "official-entity-index" },
  copa_intercontinental: { id: "copa_intercontinental", name: "Copa Intercontinental", participants: 6, format: "Disputa anual entre os campeões continentais: os campeões de África, Ásia, Concacaf e Oceania passam por eliminatórias em jogo único; o campeão da Libertadores entra na semifinal e o da Champions decide a final", season: 2026, knockout: ["semifinal", "final"], knockoutLegs: { semifinal: 1, final: 1 }, finalLegs: 1, source: "FIFA Intercontinental Cup", validationLevel: "official-entity-index" },
