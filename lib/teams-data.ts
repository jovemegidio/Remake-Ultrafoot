...
export const serieDTeams: Team[] = [
  ...
  { nome: "Portuguesa-RJ", curto: "PRJ", cidade: "Rio de Janeiro", estado: "RJ", cor1: "#dd0000", cor2: "#006633", prestigio: 15, torcida: 18000, estadio_cap: 5000, saldo: 900000, file_key: "portuguesarj_bra", estadio_nome: "Luso-Brasileiro", patrocinador: "Dafabet", escudo_url: getEscudoUrl("portuguesarj_bra"), divisao: "serie_d" },
  ...
  { nome: "Marica", curto: "MRC", cidade: "Marica", estado: "RJ", cor1: "#0066cc", cor2: "#ffffff", prestigio: 14, torcida: 8000, estadio_cap: 3000, saldo: 700000, file_key: "marica_rj", estadio_nome: "Joao Saldanha", patrocinador: "Betano", escudo_url: getEscudoUrl("marica_rj"), divisao: "serie_d" },
  { nome: "Sampaio Correa-RJ", curto: "SCR", cidade: "Saquarema", estado: "RJ", cor1: "#006633", cor2: "#dd0000", prestigio: 14, torcida: 6000, estadio_cap: 3000, saldo: 650000, file_key: "sampaiocorrea_rj", estadio_nome: "Joao Saldanha", patrocinador: "Dafabet", escudo_url: getEscudoUrl("sampaiocorrea_rj"), divisao: "serie_d" },

  // ── Clubes de estadual (SP) — completam o Campeonato Paulista (16 clubes) ────
  { nome: "Portuguesa", curto: "LUS", cidade: "Sao Paulo", estado: "SP", cor1: "#dd0000", cor2: "#006633", prestigio: 22, torcida: 300000, estadio_cap: 21000, saldo: 2500000, file_key: "portuguesa_bra", estadio_nome: "Caninde", patrocinador: "Betano", escudo_url: getEscudoUrl("portuguesa_bra"), divisao: "serie_d" },
  { nome: "Velo Clube", curto: "VEL", cidade: "Rio Claro", estado: "SP", cor1: "#dd0000", cor2: "#000000", prestigio: 15, torcida: 10000, estadio_cap: 8000, saldo: 800000, file_key: "veloclube_sp", estadio_nome: "Benito Agnelo Castellano", patrocinador: "Pixbet", escudo_url: getEscudoUrl("veloclube_sp"), divisao: "serie_d" },
  { nome: "Noroeste", curto: "NOR", cidade: "Bauru", estado: "SP", cor1: "#dd0000", cor2: "#ffffff", prestigio: 16, torcida: 30000, estadio_cap: 15000, saldo: 1100000, file_key: "noroeste_sp", estadio_nome: "Alfredo de Castilho", patrocinador: "Dafabet", escudo_url: getEscudoUrl("noroeste_sp"), divisao: "serie_d" },
]
