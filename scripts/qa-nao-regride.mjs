...
const INVENTARIO = [
  ...
  ["1.0.379", "Cota de verba da diretoria por temporada", "lib/gestao-282.ts", "verbaDisponivel282"],
  ["1.0.379", "A tela de gestao respeita a cota", "app/gestao-avancada/page.tsx", "verbaDisponivel282"],
  ["1.0.379", "Um contrato de marketing ativo por tipo", "lib/game-engine.ts", "c.type === type && c.active"],
  ["1.0.379", "Cadeia de verificacoes de loja", "package.json", "qa:loja"],
  ...
  ["1.0.381", "Supercopa nacional por pais", "lib/country-competitions.ts", "superCup"],
  ...
  ["1.0.387", "Limite de estrangeiros em campo", "lib/limite-de-estrangeiros.ts", "violacaoDeEstrangeiros"],
  ...
  ["1.0.383", "Marcacao individual chega aos pesos de lance", "lib/plano-contra-o-adversario.ts", "aplicarMarcacao"],
  ["1.0.383", "A analise do olheiro sai dos dados", "lib/scout-engine.ts", "EntradaDaAnalise"],
  ["1.0.383", "Parcelamento de transferencia", "lib/clausulas-do-negocio.ts", "resolverNegocio"],
  ["1.0.383", "As parcelas sao liquidadas na virada da semana", "lib/game-engine.ts", "saldoDeParcelas"],
  ["1.0.383", "A revenda pactuada chega ao contrato", "lib/game-engine.ts", "termos.revendaAoVendedor"],
